...
impl Evaluator {
    pub fn async_eval_prefix(&mut self, prefix: Prefix, expr: Expr) -> impl Future<Output = Object> + Send + '_  {
    ...
    pub fn async_eval_infix(&mut self, infix: Infix, expr1: Expr, expr2: Expr) -> impl Future<Output = Object> + Send + '_  {
        let mut self_clone = self.clone();
        async move {
